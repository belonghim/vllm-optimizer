...
_METRIC_FIELD_MAP = {
    ...
    "mean_queue_time_ms": "queue_time_mean",
    "p99_queue_time_ms": "queue_time_p99",
}
...
def _build_snapshots_from_ts_data(
    ...
    for ts in sorted(all_timestamps):
        ...
        snap = MetricsSnapshot(
            ...
            pods=0,
            pods_ready=0,
            swapped=int(d.get("swapped", 0)),
            tpot_mean=d.get("tpot_mean") or None,
            tpot_p99=d.get("tpot_p99") or None,
            queue_time_mean=d.get("queue_time_mean") or None,
            queue_time_p99=d.get("queue_time_p99") or None,
        )
    ...
    for ts in sorted(all_timestamps):
        for pod_name in pod_names:
            ...
            snap = MetricsSnapshot(
                ...
                pods=0,
                pods_ready=0,
                swapped=int(pod_data.get("swapped", 0)),
                tpot_mean=pod_data.get("tpot_mean") or None,
                tpot_p99=pod_data.get("tpot_p99") or None,
                queue_time_mean=pod_data.get("queue_time_mean") or None,
                queue_time_p99=pod_data.get("queue_time_p99") or None,
            )
...
def _convert_to_snapshot(vllm_metrics) -> MetricsSnapshot:
    ...
    return MetricsSnapshot(
        ...
        swapped=vllm_metrics.swapped_requests,
        tpot_mean=vllm_metrics.mean_tpot_ms or None,
        tpot_p99=vllm_metrics.p99_tpot_ms or None,
        queue_time_mean=vllm_metrics.mean_queue_time_ms or None,
        queue_time_p99=vllm_metrics.p99_queue_time_ms or None,
    )
