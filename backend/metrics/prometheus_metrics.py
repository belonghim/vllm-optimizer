...
request_success_total_metric = Counter(
    ...
    'Total number of successful vLLM requests (mirrored by optimizer)',
    ['model'],
    registry=_registry
)
...
generation_tokens_total_metric = Counter(
    ...
    'Total number of tokens generated by vLLM (mirrored by optimizer)',
    ['model'],
    registry=_registry
)
