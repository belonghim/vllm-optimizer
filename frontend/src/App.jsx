...
const css = `
  @import url('https://fonts.googleapis.com/css2?family=JetBrains+Mono:wght@300;400;500;600&family=Barlow+Condensed:wght@300;400;500;600;700&display=swap');
  ...
  *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
  ...
  .nav-btn {
    ...
    font-family: ${font.mono}; font-size: 11px; letter-spacing: 0.1em;
    color: ${COLORS.muted}; padding: 8px 16px; text-transform: uppercase;
    transition: color 0.15s, border-bottom-color 0.15s;
    border-bottom: 2px solid transparent;
  }
  .nav-btn.active { color: ${COLORS.accent}; border-bottom-color: ${COLORS.accent}; }
  .nav-btn:hover { color: ${COLORS.text}; }
  ...
  .metric-card.amber::before { background: ${COLORS.accent}; }
  .metric-card.cyan::before { background: ${COLORS.cyan}; }
  .metric-card.green::before { background: ${COLORS.green}; }
  .metric-card.red::before { background: ${COLORS.red}; }
  .metric-card.purple::before { background: ${COLORS.purple}; }

  .btn {
    font-family: ${font.mono}; font-size: 11px; letter-spacing: 0.12em;
    text-transform: uppercase; border: 1px solid; cursor: pointer;
    padding: 8px 20px; transition: all 0.15s; background: none;
  }
  .btn-primary { color: ${COLORS.accent}; border-color: ${COLORS.accent}; }
  .btn-primary:hover { background: ${COLORS.accent}; color: ${COLORS.bg}; }
  .btn-danger { color: ${COLORS.red}; border-color: ${COLORS.red}; }
  .btn-danger:hover { background: ${COLORS.red}; color: #fff; }
  .btn-cyan { color: ${COLORS.cyan}; border-color: ${COLORS.cyan}; }
  .btn-cyan:hover { background: ${COLORS.cyan}; color: ${COLORS.bg}; }
  .btn-green { color: ${COLORS.green}; border-color: ${COLORS.green}; }
  .btn-green:hover { background: ${COLORS.green}; color: ${COLORS.bg}; }
  .btn:disabled { opacity: 0.35; cursor: not-allowed; }

  .input {
    background: ${COLORS.bg}; border: 1px solid ${COLORS.border};
    color: ${COLORS.text}; font-family: ${font.mono}; font-size: 12px;
    padding: 8px 12px; width: 100%;
  }
  .input:focus { outline: none; border-color: ${COLORS.accent}; }

  select.input option { background: ${COLORS.surface}; }

  .label {
    font-family: ${font.mono}; font-size: 10px; letter-spacing: 0.12em;
  ...
  .tag-running { color: ${COLORS.green}; border-color: ${COLORS.green}; animation: blink 1s infinite; }
  .tag-idle { color: ${COLORS.muted}; border-color: ${COLORS.border}; }
  .tag-completed { color: ${COLORS.cyan}; border-color: ${COLORS.cyan}; }
  .tag-failed { color: ${COLORS.red}; border-color: ${COLORS.red}; }

  @keyframes blink { 0%,100% { opacity: 1; } 50% { opacity: 0.4; } }

  .progress-bar {
    height: 3px; background: ${COLORS.border}; position: relative;
    overflow: hidden;
  }
  .progress-fill {
  ...
  .table th {
    ...
    padding: 8px 12px; text-align: left; border-bottom: 1px solid ${COLORS.border};
  }
  .table td {
  ...
  .section-title::before {
    content: '▶'; font-size: 8px; color: ${COLORS.accent};
  }
