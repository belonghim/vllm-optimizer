  ...
  return (
    <div className="panel">
      ...
      <form onSubmit={onSubmit} className="form-grid" style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(200px, 1fr))', gap: '16px', marginBottom: '24px' }}>
        ...
        <div className="form-group">
          <label htmlFor="sla-p95-latency">Max P95 Latency (ms)</label>
          <input id="sla-p95-latency" type="number" min="0" step="1" value={p95Ms} onChange={e => onChange('p95Ms', e.target.value)} placeholder="500" />
        </div>
        <div className="form-group">
        ...
        <div className="form-group">
          ...
          <input id="sla-ttft-mean" type="number" min="0" step="1" value={meanTtftMs} onChange={e => onChange('meanTtftMs', e.target.value)} placeholder="1000" />
        </div>
        <div className="form-group">
          <label htmlFor="sla-ttft-p95">TTFT P95 (ms)</label>
          <input id="sla-ttft-p95" type="number" min="0" step="1" value={p95TtftMs} onChange={e => onChange('p95TtftMs', e.target.value)} placeholder="2000" />
        </div>
        <div className="form-group">
          <label htmlFor="sla-e2e-latency">Mean E2E Latency (ms)</label>
          <input id="sla-e2e-latency" type="number" min="0" step="1" value={meanE2eLatencyMs} onChange={e => onChange('meanE2eLatencyMs', e.target.value)} placeholder="500" />
        </div>
        <div className="form-group">
        ...
        <div className="form-group">
          ...
          <input id="sla-queue-mean" type="number" min="0" step="1" value={meanQueueTimeMs} onChange={e => onChange('meanQueueTimeMs', e.target.value)} placeholder="100" />
        </div>
        <div className="form-group">
          <label htmlFor="sla-queue-p95">Queue Time P95 (ms)</label>
          <input id="sla-queue-p95" type="number" min="0" step="1" value={p95QueueTimeMs} onChange={e => onChange('p95QueueTimeMs', e.target.value)} placeholder="500" />
        </div>
