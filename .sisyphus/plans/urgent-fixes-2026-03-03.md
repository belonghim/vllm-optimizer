...
- [ ] QA scenarios 실행 가능 (`.sisyphus/evidence/urgent-fixes-2026-03-03/`에 evidence 파일 생성)
- [ ] git diff로 변경사항 확인
...
3. **Evidence Capture** (`.sisyphus/evidence/urgent-fixes-2026-03-03/task-{N}-{scenario}.{ext}`)
...
Scenario: Verify ClusterRoleBinding namespace corrected
  ...
  Evidence: .sisyphus/evidence/urgent-fixes-2026-03-03/task-1-namespace-corrected.txt
...
#### Task 3: Verify ServiceAccount Permissions (Metis-added)
...
#### Task 5: Metric Names Colon→Underscore
...
**Instruction**: Start from clean state. Execute EVERY QA scenario from EVERY task — follow exact steps, capture evidence. Test cross-task integration (features working together). Test edge cases: empty state, invalid input, rapid actions. Save to `.sisyphus/evidence/urgent-fixes-2026-03-03/final-qa/`.
...
- [x] **Evidence**: `.sisyphus/evidence/urgent-fixes-2026-03-03/` complete with 14 tasks × 2+ scenarios each
